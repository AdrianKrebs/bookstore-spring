...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	@Query("SELECT NEW org.books.persistence.dto.OrderInfo(o.nr, o.date, o.amount, o.status) "
			+ "FROM Order o WHERE o.customer = :customer AND YEAR(o.date) = :year")
	public List<OrderInfo> findByCustomerAndYear(@Param("customer") Customer customer, @Param("year") int year);
}
